...
#ifdef SOUL_BLADE       
#define PEER_SYNC_MSG_STATE2_PEER_POWEROFF_REQ      (1 << 3)  
#endif
...
#ifdef SOUL_BLADE       
#define PEER_SYNC_STATE_IS_PEER_POWEROFF_REQ(x) \
    ((PEER_SYNC_GET_STATE2(x) & PEER_SYNC_MSG_STATE2_PEER_POWEROFF_REQ) ? TRUE : FALSE)
#endif
/*!@} */
...
#ifdef SOUL_BLADE       
#define PEER_SYNC_STATE_SET_IS_PEER_POWEROFF_REQ(x) \
   ((x) ? PEER_SYNC_MSG_STATE2_PEER_POWEROFF_REQ : 0)
#endif
/*!@} */
...
#ifdef SOUL_BLADE       
                             (PEER_SYNC_STATE_SET_IS_PEER_POWEROFF_REQ(ps->peer_poweroff_req)) +
#endif        
...
#ifdef SOUL_BLADE       
    ps->peer_poweroff_req        = PEER_SYNC_STATE_IS_PEER_POWEROFF_REQ(ind->msg);
#endif

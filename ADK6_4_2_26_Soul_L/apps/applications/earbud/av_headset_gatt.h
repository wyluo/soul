...
#ifdef SOUL_DEVICE_INFO    
    /*! Task for handling Heart Rate related messages */
    TaskData    gatt_dis_task;
#endif
#ifdef INCLUDE_PTEK    
    /*! Task for handling Heart Rate related messages */
    TaskData    gatt_hrs_task;
#endif
    
#ifdef INCLUDE_BME300    
        /*! Task for handling Heart Rate related messages */
        TaskData    gatt_bme_task;
#endif
...
void Pre_ptekEnable(void);//jim
void Pre_ptekDisable(void);//jim
//jim

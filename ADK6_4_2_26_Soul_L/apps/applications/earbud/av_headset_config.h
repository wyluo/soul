...
#ifdef SOUL_BLADE
#define appConfigStandbyTimeout()     (300)
//#define appConfigAutoHandsetPairingTimeout()    (180)   //(300)   // Power off after 3 minutes if no connect
#define appConfigAutoHandsetPairingTimeout()    (120) //modify by jim 2020525
#else 
...
#define appConfigMinVolumedB() (-45-3)// (-45) modify by jim 20190618

/*! Maximum volume gain in dB */
#define appConfigMaxVolumedB() (-3)// (0) modify by jim 20190618

/*! Default volume gain in dB */
#define appConfigDefaultVolumedB() (appConfigMaxVolumedB()) // (-10)modify by jim 20190618
...
#ifdef SOUL_BLADE        
#define appConfigScoMic2()                      (1)          /* for 2-mic */
#else
...
#define appConfigAvrcpMs()                 (800)//jim
...
#ifdef SOUL_BLADE  
#define appConfigChargerFastCurrent()                  (50)            //(100)  set the fast charing current to 55mA        
#else
...
#define appConfigBatteryVoltageLow()        (3450)//  jim (3300)
#define appConfigBatteryVoltageCritical()   (3200) // jim (3000)
//!@}
...
#define appConfigBatteryReadPeriodMs() D_SEC(5) //jim  20190701
...
extern const ptekConfig ptek_config;
#define appConfigPtek() (&ptek_config)
#endif

...
#define appSmIs_Peer_Pairing() \
    (appGetState() == APP_STATE_PEER_PAIRING) // JIM 20190628
...
//add by kimny  jim
extern void appSmFactoryReset_later(uint32 delay);
extern void appSmCancelLimboTimeout(void); //add by kimny  jim

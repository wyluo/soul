...
*/    
#ifdef SOUL_BLADE
uint8 GetHfpStateSe(void)
{
uint8 ret = HFP_STATE_NULL;
...
//add by JIM / kimny  20190703
#if	1//def AT_BATT_REPORT
	avAtCmdEnableBattReport();
	avAtCmdSendBatt(appBatteryGetPercent());
#endif

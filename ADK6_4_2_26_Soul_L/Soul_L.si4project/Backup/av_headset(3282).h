...
#define Jim // add by jim 20190907
#define ALEX // add by jim 20191014
#define AUTO_PAIRINGx // add by jim 20190719
#define LONG_PRESS_POWERON
...
#if defined(SOUL_DEVICE_INFO)
/*! Get pointer to the Device Info server task */
#define appGetGattDisTask()                 (&globalApp.gatt.gatt_dis_task)
#endif

#if defined(INCLUDE_PTEK)
/*! Get pointer to the GAP server task */
#define appGetGattHrsTask()                 (&globalApp.gatt.gatt_hrs_task)
#endif
#if defined(INCLUDE_BME300)
/*! Get pointer to the GAP server task */
#define appGetGattBmeTask()                 (&globalApp.gatt.gatt_bme_task)
#endif
...
#if defined(SOUL_DEVICE_INFO)
#define appGetGattDeviceInfoServerInst(inst)       (&appGetGattInstance(inst)->device_info_server)
#endif

#if defined(INCLUDE_PTEK)
/*! Get pointer to instance of the HR server info  */
#define appGetGattHRServerInst(inst)       (&appGetGattInstance(inst)->hr_server)
#endif
#if defined(INCLUDE_BME300)
/*! Get pointer to instance of the HR server info  */
#define appGetGattBmeServerInst(inst)       (&appGetGattInstance(inst)->bme_server)
#endif

...
extern void My_appScoDucoData(uint8 duco_ota_msg_id,uint8 duco_buff);
extern void My_appScoDucoData_OTA(uint8 duco_ota_msg_id,uint8 duco_buff);
...
enum av_headset_scofwd_ota_messages
{
    ...
    SFWD_OTA_POWEROFF_TONE,/* Add by jim SBT 20191107*/
    
    SFWD_OTA_Peer_PairingHeadset/* Add by jim SBT 20191107*/
};
